...
const LoadingCards = () => {
  ...
  return (
    <>
      <nav className="bg-white flex fixed top-0 w-full px-5 py-2 items-center z-10 border-b border-slate-200">
        ...
        <div className="ml-auto">
          <div className="flex gap-2 items-center">
            <img className="rounded-full bg-gray-300 animate-pulse w-7 h-7" />
